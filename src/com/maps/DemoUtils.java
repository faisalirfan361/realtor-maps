...
public class DemoUtils {
    ...
    public static boolean initializeLibrary(final Activity context) {
        ...
        /*yeah path saray print kerwa ker check kero jin location per yeh dikh raha hai wahan fies hain k nain 
        usay files nain mil rahien?*/
...
//         + "/PreinstalledMaps");
    ...
    public static void showApiKeyErrorDialog(Activity currentActivity) {
        ...
        alertDialog.setPositiveButton(
                "OK",//currentActivity.getResources().getString(com.skobbler.ngx.R.string.ok_label)//OK added by Wasif
